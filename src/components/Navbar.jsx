      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            <Link to="/form" className="text-gray-700 hover:text-orange-500 px-3 py-2 transition-colors" onClick={closeAllMenus}>
              Form
            </Link>
          ...
          {isOpen && (
            ...
            >
              <div className="px-4 py-3 space-y-2" onClick={handleMobileLinkClick}>
                ...
                <Link to="/form" className="block px-3 py-2 text-gray-700 hover:bg-orange-50 hover:text-orange-600 rounded">
                  Form
                </Link>
